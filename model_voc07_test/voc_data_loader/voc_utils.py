...
root_dir = os.environ['DLPLAYGROUND'] + "/model_voc07_test/VOC2007/"
img_dir = os.path.join(root_dir, 'JPEGImages/')
ann_dir = os.path.join(root_dir, 'Annotations')
set_dir = os.path.join(root_dir, 'ImageSets')
...
def imgs_from_category(cat_name, dataset):
    ...
    """
    filename = os.path.join(set_dir, "Main/" + cat_name + "_" + dataset + ".txt")
    df = pd.read_csv(
        filename,
