...
class fasterrccn_params(hyperparameters):

    def __init__(self):
        super(fasterrccn_params, self).__init__()

        # Parameters that are important to fasterrccn:
...
class fasterrccn(network):
    """docstring for fasterrccn"""

    def __init__(self, params=None):
        name = "fasterrccn"
        if params is None:
            print "Creating default params"
            params = fasterrccn_params()
        super(fasterrccn, self).__init__(name, params)
