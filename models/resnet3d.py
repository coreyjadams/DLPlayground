...
class resnet3d_params(hyperparameters):

    def __init__(self):
        super(resnet3d_params, self).__init__()

        # Parameters that are important to resnet3d:
...
class resnet3d(network):
    """docstring for resnet3d"""

    def __init__(self, params=None):
        name = "resnet3d"
        if params is None:
            print "Creating default params"
            params = resnet3d_params()
        super(resnet3d, self).__init__(name, params)
    ...
    def downsample_block(self, input_tensor,
        ...
        with tf.variable_scope(name+"identity"):
            y = tf.layers.conv3d(input_tensor,
                                 n_filters,
                                 kernel_size=[1, 1, 1],
                                 strides=[2, 2, 2],
                                 padding='same',
    ...
    def build_network(self, input_tensor, is_training=True, n_output_classes=10):
        ...
        x = tf.layers.conv3d(input_tensor,
